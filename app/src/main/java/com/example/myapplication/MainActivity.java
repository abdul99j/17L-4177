    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < arraylist.size(); i++) {
                    ...
                    {
                        Toast.makeText(getApplicationContext(),"LMAO DUPLICATE NI INSERT KRTE BC",Toast.LENGTH_LONG).show();
                    }
                }/*
                for(int i=0;i<arraylist.size();i++){
                    if(arraylist.get(i).isPresent()){
                    temp.get(i).setPresent(true);}
                    else
                    {
                        temp.get(i).setPresent(false);
                    }
                }*/
                arrayAdapter._unselectAll(arraylist);
        ...
        updatebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                arrayAdapter.update(arraylist);
//                for (int i = 0; i < arraylist.size(); i++) {
//                    arraylist.get(i).setDate(date);
//                    datastore = mydb.getWritableDatabase();
//                    arraylist.get(i).load(cursor_datastore);
...
//                }
        ...
        deletebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(status<0)
                {
                    Toast.makeText(getApplicationContext(),"EXCEPTION LOL",Toast.LENGTH_LONG).show();
                }
                else{
